...
<div class="flex gap-16 justify-center items-center mt-8">
    <div class="flex flex-col items-center">
        ...
        <p class="text-white text-3xl text-center mt-8">Thank you to everyone who participated this year!</p>
        <p class="text-white text-3xl text-center mt-8">Check back soon for details about LBC2 2026.</p>
...
<div class="bg-blue-100">
    ...
    >
      {#each imgNum as index}
        <img src={`/images/2025/image${index}.jpeg`} alt={`Image ${index}`} class="my-8 object-cover rounded ml-4"/>
      {/each}
    </Carousel>
    <img src="/images/wavesOpacity.svg" alt="divider" class="h-auto w-screen rotate-180">
</div>
...
<div class="bg-blue-100">
    ...
    <img src="/images/sponsors.png" alt="sponsors" class="mx-auto mt-8">
    <img src="/images/wavesOpacity.svg" alt="divider" class="h-auto w-screen rotate-180">
</div>
<div>
